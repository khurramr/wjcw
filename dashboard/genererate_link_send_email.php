    ...
    <div class="col-md-12 mt-4" style="margin-left:0px;">
        <div class="card">
              ...
              <button class="btn btn-success btn-lg" id="btn-link">WHATSAPP</button>
                  &nbsp;&nbsp;
                  <div class="input form-control" id="whatsapp-share"><a href="https://web.whatsapp.com/send?text=http://wjcwcf.com/index.php?member_id=<?= $member_id; ?>" data-action="share/whatsapp/share" target="_blank"><h4 class="h_color">SHARE VIA WHATSAPP WEB</h4></a></div>
              </div>
              <div class="form-inline mt-4">
