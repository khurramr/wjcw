   ...
   <div class="card">
    ...
    <div class="card-body">                    
                   <table id="received_history" class="table  display table-hover text-center" style="font-size:90%">
                        ...
                        ?>        
                            <tr style='color:red' id="invalid-token-row-<?php echo $row['id']; ?>">
                                <td><?= $i++; ?></td>
                                ...
                                <td>£12</td>
                                <td><button class="btn btn-danger btn_delete invalid-token-delete-btn" data-id="<?php echo $row['id']; ?>">DELETE</button></td>
                            </tr>    
                        <?php  } ?>
