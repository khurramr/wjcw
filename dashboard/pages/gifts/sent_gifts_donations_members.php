...
/*        font-weight: bold*/
	...
	Label the data
	*/
	td:nth-of-type(1):before { content: "Recepient Id"; }
	td:nth-of-type(2):before { content: "Recepient Name"; }
...
<div class="container-fluid mt-0">
            <div class="card">
              <div class="card-header">
                <h class="card-title h_fonts h_color">GIFTS/DONATIONS SENT STAGES</h>
              </div>
              <!-- /.card-header -->
                           <div class="card-body">
                         ...
                         ?>
                                <tr>
                                   <?php 
                                        if($row['verified'] == 1){
                                    ?>
                                    <td style="color:green"><?= $row["received_by"] ?></td>
                                    <?php }else{ ?>
                                    <td style="color:red"><?= $row["received_by"] ?></td>                                    
                                    <?php } ?>
