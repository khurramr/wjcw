                        ...
                        <div id="navbarNav" class="collapse navbar-collapse align-self-start ">
                            <ul id="menu-menu" class="navbar-nav mx-auto my-2 mt-4 p-1 text-center font-weight-bolder">
                                <li class="nav-item  ">
                                    <a class="nav-link "
                                    class="header-home"
                                    title="Home" href="../index.php">Home</a>
                                </li>
                        <li id="menu-item-46" class=""><a 
                        href="../pages/how_it_works.php" class="header-how-it-works nav-link" title="How It Works">How It Works</a>
                        </li>
                                <li class="nav-item">
                                    <a
                                    class="header-join-us nav-link" title="Join us" href="../my_account/join-us.php">Join us</a>
                                </li>
                                <li 
                                class="nav-item">
                                    <a 
                                    class="header-contact-us nav-link" title="Contact Us" href="../my_account/contact-us.php">Contact Us</a>
                                </li>
                                <li class="nav-item">
                                    <a class="header-login nav-link" 
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse align-self-start ">
                    <ul id="menu-menu-1" class="navbar-nav mx-auto my-2 mt-4">
                        <li class="">
                            <a class="header-home nav-link" title="Home" href="../index.php">Home</a>
                        </li>
                        <li id="menu-item-46" class=""><a href="../pages/how_it_works.php"
                        class="header-how-it-works nav-link" title="How It Works">How It Works</a>
                        </li>
                        <li>
                            <a class="header-join-us nav-link"
                            title="Join us" href="../my_account/join-us.php">Join us</a>
                        </li>
                        <li><a class="header-contact-us nav-link" title="Contact Us"
                        href="../my_account/contact-us.php">Contact Us</a>
                        </li>
                        <li>
                            <a class="header-login nav-link" title="Login"  href="../my_account/login.php">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
